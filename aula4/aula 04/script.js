//selecionando item e alterando titulo
let alterarTitulo = document.getElementById('tituloPag').innerText = "Lista de Felinos";
//selecionando itens
let tagH2 = document.querySelectorAll('h2');
let tagP = document.querySelectorAll('p');
let imagem = document.querySelectorAll('img');
let tagH6 = document.querySelectorAll('h6');
...
const listadeFelinos = [
    ...
    imgUrl: './imagens/pantera-negra.jpeg',
    ...
    createdAt: '2021-05-22T23:12:11.837Z'
     ...
     //percorrendo array e alterando itens  
    for (let i = 0; i < tagH2.length; i++) {
        tagH2[i].innerText = listadeFelinos[i].title;
        imagem[i].src = listadeFelinos[i].imgUrl;
        tagP[i].innerText = listadeFelinos[i].description;
        tagH6[i].innerText = listadeFelinos[i].createdAt;
